...
<p align="center">
  <a href="https://matthewoldfield.com">
    <img alt="Gatsby" src="https://avatars.githubusercontent.com/u/20761346?s=120&v=4" width="60" />
  </a>
</p>
<h1 align="center">
...
* [GetForm](https://app.getform.io/forms/30451)
* [Disqus](https://asmatticgatsbyblog.disqus.com/admin/settings/universalcode/)
* [Google Analytics](https://analytics.google.com/analytics/web/#/p282906656/reports/reportinghub)
...
1. **Setup the project by.**
    ...
    git clone https://github.com/asmattic/asmattic-gatsby-blog.git
    cd asmattic-gatsby-blog 
    npm install
    ```
